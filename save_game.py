...
def save_progress(player_name, current_day, cash, difficulty, status, rng_seed, save_id=None):
    ...
    if save_id is None:
        ...
        """
        kursori.execute(sql, (player_name, current_day, cash, difficulty, status, rng_seed, now, now))
        ...
        sql = """
            ...
            WHERE save_id=%s
        """
        kursori.execute(sql, (player_name, current_day, cash, difficulty, status, rng_seed, now, save_id))
