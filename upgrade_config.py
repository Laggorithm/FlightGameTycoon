...
DEFAULT_ECO_FACTOR_PER_LEVEL: Decimal = Decimal("0.90")  # -10 % per taso (korottaa kannattavuutta vähentämällä veroja/fee-maksuja)
DEFAULT_ECO_FLOOR: Decimal = Decimal("0.50")             # Ekokerroin ei putoa alle 0.50
